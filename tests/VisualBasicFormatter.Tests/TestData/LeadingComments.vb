Module LeadingComments
    ...
    Public Sub HandlesOverrunChain()
        ...
        Dim companies = State.Companies.Values.Where(AddressOf FilterDivision).Where(Function(g) FilterLegalForm(g.LegalForm)).Where(Function(g) Not visited.Contains(g))
    End Sub
