...
Public Class QueryDemo
    ...
    Public Sub Run(employees As List(Of Employee))
        ...
        Dim highEarners = From employee In employees Where employee.Salary > 100000 AndAlso employee.Department = "Engineering" Order By employee.Salary Descending Select employee.Name, employee.Salary

        Dim byDepartment = From employee In employees Group employee By Key = employee.Department Into Group, Count() Select Department = Key, Headcount = Count
