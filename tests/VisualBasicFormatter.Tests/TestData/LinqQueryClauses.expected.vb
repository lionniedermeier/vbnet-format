...
Public Class QueryClauses
    ...
    Public Sub Run(employees As List(Of Employee), departments As List(Of Department))
        ...
        Dim staffing =
            ...
            Select employee.Name, Department = department.Name

        Dim rosters =
            From department In departments
            Group Join employee In employees On department.Id Equals employee.DepartmentId Into Members = Group
            Select department.Name, Members
        ...
        Dim overlyLongExtremelyDetailedVariableName =
            From employee In employees
        ...
        Dim page =
            From employee In employees
            Let bonus = employee.Salary * 0.1D
            Where bonus > 1000D
            Order By employee.Department, employee.Salary Descending
            Skip 10
            Take 25
        ...
        Dim window =
            From employee In employees
            Skip While employee.Salary < 50000D
            Take While employee.Salary < 200000D
            Select employee.Name
