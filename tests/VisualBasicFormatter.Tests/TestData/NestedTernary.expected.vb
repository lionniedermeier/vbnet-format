Public Class EmployeeReport
    ...
    Public Sub Report()
        ...
        Dim nestedConditional = If(
            _employees.Count > 10, "Large", If(_employees.Count > 5, "Medium", If(_employees.Count > 0, "Small", "Empty"))
        )
        ...
        Dim anExtremelyLongNestedConditionalResultNameForDemonstrationPurposes = If(
            _employees.Count > 10, "LargeSized", If(_employees.Count > 5, "Medium", If(_employees.Count > 0, "Small", "Empty"))
        )
