Module SelectCaseInline
    ...
    Public Function DescribeVeryVeryVeryVeryLongOverload(ByVal depth As Integer) As String
        Select Case depth
            Case 0 : Return "SomeVeryVeryVeryVeryVeryVeryVeryVeryVeryVeryVeryVeryVeryVeryLongLongLongLongLongLongResultX"
        End Select
    End Function
    ...
    Public Function DescribeWideCase(ByVal kind As SyntaxKind) As Boolean
        Select Case kind
            Case SyntaxKind.CBoolKeyword, SyntaxKind.CDateKeyword, SyntaxKind.CDblKeyword, SyntaxKind.CSByteKeyword, SyntaxKind.CByteKeyword, SyntaxKind.CCharKeyword, SyntaxKind.CShortKeyword : Return True
        End Select
    End Function
